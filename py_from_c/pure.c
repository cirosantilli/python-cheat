...
static PyObject*
defined_in_c_get_offset(PyObject *self, PyObject *args) {
    (void)self;
    (void)args;
    return Py_BuildValue("i", 2);
}

static PyMethodDef DefinedInCMethods[] = {
    {"get_offset", defined_in_c_get_offset, METH_VARARGS,
...
int main(int argc, char *argv[]) {
    ...
    Py_Initialize();
    Py_InitModule("defined_in_c", DefinedInCMethods);
...
static struct PyModuleDef definedInC =
{
